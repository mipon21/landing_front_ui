...
<?php $__env->startSection('title', 'Add How It Works Step'); ?>
...
<form action="<?php echo e(route('admin.how-it-works.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="badge_text" value="<?php echo e(old('badge_text')); ?>" placeholder="e.g., Easy Steps">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Section Heading <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="heading" value="<?php echo e(old('heading')); ?>" required placeholder="e.g., How it Works">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="step_number" value="<?php echo e(old('step_number')); ?>" required min="1" max="99">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="step_title" value="<?php echo e(old('step_title')); ?>" required placeholder="e.g., Download App & create a free account">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Step Description <span class="text-danger">*</span></label>
                        <textarea class="form-control" name="step_description" rows="4" required><?php echo e(old('step_description')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\landing\resources\views/admin/how-it-works/create.blade.php ENDPATH**/ ?>