...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-pre-footer-cta')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Heading <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="heading" value="<?php echo e(old('heading', $preFooterCta['heading'])); ?>" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Description <span class="text-danger">*</span></label>
                <textarea class="form-control" name="description" rows="3" required><?php echo e(old('description', $preFooterCta['description'])); ?></textarea>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Call Button Text <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="call_text" value="<?php echo e(old('call_text', $preFooterCta['call_text'])); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Call Button URL <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="call_url" value="<?php echo e(old('call_url', $preFooterCta['call_url'])); ?>" required placeholder="e.g., tel:123-456-7890">
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="show_call_button" value="1" id="show_call_button" <?php echo e(old('show_call_button', $preFooterCta['show_call_button']) ? 'checked' : ''); ?>>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="email_text" value="<?php echo e(old('email_text', $preFooterCta['email_text'])); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Email Button URL <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="email_url" value="<?php echo e(old('email_url', $preFooterCta['email_url'])); ?>" required placeholder="e.g., mailto:someone@example.com">
                        <small class="text-muted">Use mailto: prefix for email links (e.g., mailto:someone@example.com)</small>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="show_email_button" value="1" id="show_email_button" <?php echo e(old('show_email_button', $preFooterCta['show_email_button']) ? 'checked' : ''); ?>>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-logo')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Current Logo</label>
                <div>
                    <?php if($footerLogo): ?>
                        <img src="<?php echo e(asset('storage/' . $footerLogo)); ?>" alt="Footer Logo" style="max-height: 80px; margin-bottom: 15px;" class="d-block">
                        <a href="<?php echo e(route('admin.settings.footer.delete-logo')); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete the logo?')">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-details')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Details Text <span class="text-danger">*</span></label>
                <textarea class="form-control" name="details" rows="4" required><?php echo e(old('details', $footerDetails)); ?></textarea>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-app-store-buttons')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">App Store URL</label>
                        <input type="url" class="form-control" name="app_store_url" value="<?php echo e(old('app_store_url', $appStoreButtons['app_store_url'])); ?>" placeholder="e.g., https://apps.apple.com/...">
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="show_app_store" value="1" id="show_app_store" <?php echo e(old('show_app_store', $appStoreButtons['show_app_store']) ? 'checked' : ''); ?>>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" name="google_play_url" value="<?php echo e(old('google_play_url', $appStoreButtons['google_play_url'])); ?>" placeholder="e.g., https://play.google.com/...">
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="show_google_play" value="1" id="show_google_play" <?php echo e(old('show_google_play', $appStoreButtons['show_google_play']) ? 'checked' : ''); ?>>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-copyright')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Copyright Text <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="copyright_text" value="<?php echo e(old('copyright_text', $copyrightText)); ?>" required>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.settings.footer.update-newsletter-backend-url')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Backend Processing URL <span class="text-danger">*</span></label>
                <input type="url" class="form-control" name="backend_url" value="<?php echo e(old('backend_url', $newsletterBackendUrl)); ?>" required placeholder="https://tastyso.com/newsletter">
        ...
        <?php if($quickLinks->count() > 0): ?>
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary" onclick="editQuickLinksMenu(<?php echo e($menu->id); ?>, '<?php echo e($menu->label); ?>', '<?php echo e($menu->url); ?>', <?php echo e($menu->sort_order); ?>, <?php echo e($menu->is_active ? 'true' : 'false'); ?>)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <form action="<?php echo e(route('admin.settings.footer.destroy-menu', $menu->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this menu?');">
                                        <?php echo csrf_field(); ?>
        ...
        <?php if($supportMenus->count() > 0): ?>
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $supportMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><strong><?php echo e($menu->label); ?></strong></td>
                                <td><?php echo e($menu->url ?? 'N/A'); ?></td>
                                <td><?php echo e($menu->sort_order); ?></td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary" onclick="editSupportMenu(<?php echo e($menu->id); ?>, '<?php echo e($menu->label); ?>', '<?php echo e($menu->url); ?>', <?php echo e($menu->sort_order); ?>, <?php echo e($menu->is_active ? 'true' : 'false'); ?>)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <form action="<?php echo e(route('admin.settings.footer.destroy-menu', $menu->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this menu?');">
                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addQuickLinksModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.settings.footer.store-menu')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><strong><?php echo e(ucfirst($link->platform)); ?></strong></td>
                                <td><code><?php echo e($link->icon_class); ?></code></td>
                                <td><a href="<?php echo e($link->url); ?>" target="_blank"><?php echo e(Str::limit($link->url, 30)); ?></a></td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary" onclick="editSocialLink(<?php echo e($link->id); ?>, '<?php echo e($link->platform); ?>', '<?php echo e($link->icon_class); ?>', '<?php echo e($link->url); ?>', '<?php echo e($link->label); ?>', <?php echo e($link->sort_order); ?>, <?php echo e($link->is_active ? 'true' : 'false'); ?>)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <form action="<?php echo e(route('admin.settings.footer.destroy-social-link', $link->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this social link?');">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="btn btn-sm btn-danger">
                                            <i class="bi bi-trash"></i>
...
<div class="modal fade" id="addSocialLinkModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.settings.footer.store-social-link')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
...
function editQuickLinksMenu(id, label, url, sortOrder, isActive) {
    document.getElementById('editQuickLinksForm').action = '<?php echo e(route("admin.settings.footer.update-menu", ":id")); ?>'.replace(':id', id);
...
function editSupportMenu(id, label, url, sortOrder, isActive) {
    document.getElementById('editSupportForm').action = '<?php echo e(route("admin.settings.footer.update-menu", ":id")); ?>'.replace(':id', id);
...
function editSocialLink(id, platform, iconClass, url, label, sortOrder, isActive) {
    document.getElementById('editSocialLinkForm').action = '<?php echo e(route("admin.settings.footer.update-social-link", ":id")); ?>'.replace(':id', id);
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\landing\resources\views/admin/settings/footer/index.blade.php ENDPATH**/ ?>