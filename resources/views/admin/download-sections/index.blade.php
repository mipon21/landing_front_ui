                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="{{ route('admin.download-sections.edit', $section) }}" class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.download-sections.destroy', $section) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                        @csrf
                                        @method('DELETE')
